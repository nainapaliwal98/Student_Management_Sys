...
## using database sqllite3 is use for minor data and mysql is use for large data
...
#### Manage Frame ######
        ...
        combo_gender.grid(row=4,column=1,pady=10,padx=20,stick="w")
...
######  Detail Frame #######
        ...
        combo_search.grid(row=0,column=1,pady=10,padx=20,stick="w")

        txt_Search=Entry(Detail_Frame,width=15,textvariable=self.search_by,font=("times new roman",10,"bold"),bd=5,relief=GROOVE)
        ...
        showallbtn=Button(Detail_Frame,text="Show All",width=10,pady=5,command=self.search_data).grid(row=0,column=4,padx=10,pady=10)
